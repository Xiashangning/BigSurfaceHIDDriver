 ...
 */
class EXPORT SurfaceTouchscreenHIDEventDriver : public VoodooI2CMultitouchHIDEventDriver {
    OSDeclareDefaultStructors(SurfaceTouchscreenHIDEventDriver);
...
#endif /* SurfaceTouchscreenHIDEventDriver_hpp */
