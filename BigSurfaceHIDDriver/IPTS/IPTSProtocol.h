...
#define IPTS_DEVICE_METADATA_REPORT_ID      0x06
#define IPTS_DEVICE_METADATA_REPORT_SIZE    119

#define IPTS_DEVICE_MODE_REPORT_ID          0x05

#define IPTS_SINGLETOUCH_REPORT_ID          0x40

#define IPTS_HID_REPORT_IS_TOUCH(x) (x==7 || x==8 || x==10 || x==11 || x==12 || x==13 || x==26 || x==28)
...
/**
 * struct IPTSDataHeader - Header that is prefixed to the data in the receive buffer.
